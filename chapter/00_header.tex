...
\usepackage[pdftex,colorlinks=false,
          ...
          \pdfinfo{
            /Title      (Seminararbeit - Das Spring Framework)
            /Author     (Stefan Sobek)
            /Keywords   (FernUni Hagen, Spring, Komponentenbasierte Programmierung, 2010/2011)
          }

\hypersetup{
    pdftitle={Masterarbeit - Exchange of characteristic data},
