...
fontsize=11pt,						  		% Schriftgrˆﬂe (12pt, 11pt (Standard))
%BCOR=20mm,							% Bindekorrektur, bspw. 1 cm
DIV=14,							% f¸hrt die Satzspiegelberechnung neu aus scrguide 2.4
...
% Kapitelüberschriften (chapter) weiter oben beginnen lassen
% normaleweise ist bei scrreprt sehr viel Abstand zum oberen Rand
\renewcommand*\chapterheadstartvskip{\vspace*{-1.5cm}}

%Seitenränder anpassen
%\usepackage[left=40mm,right=20mm,top=30mm,bottom=20mm]{geometry}
%\usepackage[bottom=35mm]{geometry}
\usepackage[left=30mm,right=30mm,top=25mm,bottom=25mm, bindingoffset=1.2cm]{geometry}
