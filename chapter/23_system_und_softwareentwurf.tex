...
Die Kontextabgrenzung in \autoref{fig:bausteinsicht_level0} zeigt das System im Zusammenspiel mit anderen Systeme und zeigt somit gleichsam die Systemgrenzen auf. 
...
\subsection{Level 2 - Whiteboxansicht - Komponente Processor}\index{Whiteboxansicht}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=0.82\textwidth]{images/bausteinsicht_plib_level2_processor.png}
...
\subsection{Level 3 - Whiteboxansicht - Komponente Handler}\index{Whiteboxansicht}
...
\subsection{Level 3 - Whiteboxansicht - Komponente Analyser}\index{Whiteboxansicht}
