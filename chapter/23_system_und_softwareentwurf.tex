...
Wenn von WebServices gesprochen wird, dann werden meistens SOAP-basierte WebServices gemeint. Allerdings gibt es die sogenannten SOAP-basierten WebServices als auch die RESTful WebServices. Anforderung ist es ein Web Service zu implementieren. Dazu muss entschieden werden, ob ein SOAP-basierter oder RESTful Web Service implementiert werden soll.
