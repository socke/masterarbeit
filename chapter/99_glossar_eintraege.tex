...
\newglossaryentry{Jersey}{name=Jersey, description={Framework zur Erstellung von RESTful Webservices in Java}}
...
\newglossaryentry{Applikationskontext}{name=Applikationskontext, description={Auch application context. Die Ausführungsumgebung einer Software Applikation innerhalb eines Applikationsservers. Wird an eine URL gekoppelt, unter der die Applikation erreichbar ist}}
