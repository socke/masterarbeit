...
\newglossaryentry{Applikationskontext}{name=Applikationskontext, description={Auch application context. Die Ausführungsumgebung einer Software Applikation innhalb eines Applikationservers. Wird an eine URL gekoppelt, unter jener die Applikation erreichbar ist}}
