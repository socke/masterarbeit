...
\subsection{Einbinden in Buildprozess mit Maven}\index{Maven}
...
Um JAXB mit Maven zu nutzen, muss das Maven-Plugin in die \gls{pom} eingetragen werden. Listing \ref{lst:jaxbplugin} zeigt den XML-Auschnitt aus der \gls{pom}. \index{Maven!pom.xml}

\begin{lstlisting}[caption=JAXB Maven Plugin, language=, label=lst:jaxbplugin]
            <plugin>
